## This script defines a Node2D that represents a building in the game.
## It handles the visibility of the building node and updates its state
...
# Variable holds the value of pressed
