...
func _on_shop_pressed():
	if shop_label.visible == false:
		...
		var shop_tutorial: Node = load("res://Welt/Tutorial/Shop_t/Shop_tutorial.tscn").instantiate()
...
func _building_pit():
	if building_pit_label.visible == false:
		...
		var building_t: Node = load("res://Welt/Tutorial/Buildingpit_t/Buildingpit_t.tscn").instantiate()
