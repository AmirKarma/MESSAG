## This script represents a building entity in the game.

extends Node2D

# ID of the building
## Constant variable storing the unique identifier of the building.
var id: int = 11

# Variable holdes the value of pressed
## Boolean variable indicating whether any button has been pressed.
var pressed: bool = false

# Nodes for the scene
## Reference to the buildings node in the scene.
@onready var buildings: Node2D = get_node("/root/World/buildings")
## Reference to the animated sprite representing the building icon.
